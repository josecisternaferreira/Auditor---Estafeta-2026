...
def calcular_tarifa_base(peso_facturable, tarifas_ruta):
    ...
    if peso_facturable <= 1:
        ...
        # LÓGICA CORRECTA basada en PESO TOTAL:
        # - hasta100kg: para peso total 51-100kg (exceso 1-50kg)
        # - hasta500kg: para peso total 101-500kg (exceso 51-450kg)
        # - mas500kg: para peso total >500kg (exceso >450kg)
        
        if peso_facturable <= 100:  # peso total 51-100kg
            tarifa_kg = tarifas_ruta.get('hasta100kg', 0)
        elif peso_facturable <= 500:  # peso total 101-500kg
            tarifa_kg = tarifas_ruta.get('hasta500kg', 0)
        else:  # peso total >500kg
