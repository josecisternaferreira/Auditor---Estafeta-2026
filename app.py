...
def calcular_tarifa_base(peso_facturable, tarifas_ruta):
    ...
    if peso_facturable <= 1:
        ...
        # LÓGICA CORRECTA: comparar kg_adicionales (exceso)
        if kg_adicionales <= 50:  # exceso hasta 50kg (51-100kg total)
            tarifa_kg = tarifas_ruta.get('hasta100kg', 0)
        elif kg_adicionales <= 500:  # exceso hasta 500kg (101-550kg total)
            tarifa_kg = tarifas_ruta.get('hasta500kg', 0)
        else:  # exceso mayor a 500kg (más de 550kg total)
